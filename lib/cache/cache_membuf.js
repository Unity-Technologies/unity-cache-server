...
class PutTransactionMembuf extends PutTransaction {
    ...
    finalize(callback) {
        return super.finalize(callback);
    }
    ...
    getWriteStream(type, size, callback) {
        ...
        this._streams[type].buffer = Buffer.alloc(size, 0, 'ascii');
        this._streams[type].pos = 0;
