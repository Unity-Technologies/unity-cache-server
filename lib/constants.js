const constants = {
    ...
    LOG_TEST: 4,
    LOG_DBG: 5,
    DEFAULT_CACHE_DIR: __dirname + '/cache5.0',
    DEFAULT_CACHE_SIZE: 1024 * 1024 * 1024 * 50,
    DEFAULT_PORT: 8126,
    DEFAULT_WORKERS: require('os').cpus().length
};
...
constants.DEFAULT_LOG_LEVEL = constants.LOG_TEST;
