...
class CacheServer {
    ...
    constructor(cache, options) {
        ...
        this._clientRecorder = null;
        this._clientRecorderOptions = {};

        if(options.clientRecorder) {
            this._clientRecorderOpts = options.clientRecorderOptions;
    ...
    start(errCallback) {
        ...
        this._server = net.createServer(socket => {
            ...
            const streamRecorder = new ClientStreamRecorder(this._clientRecorderOpts);
            ...
            socket.on('close', () => {
                ...
                if(this._clientRecorder)
                    socket.pipe(streamRecorder); // Record the incoming byte stream to disk
