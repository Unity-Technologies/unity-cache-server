...
class CacheFS {
    ...
    _FreeSpace(freeSize) {
        ...
        globals.log(consts.LOG_TEST, "Begin freeing cache space. Current size: " + this.totalDataSize);
    ...
    _UnlockFreeSpace() {
        this._freeingSpaceLock--;
        if (this._freeingSpaceLock == 0) {
            globals.log(consts.LOG_TEST, "Completed freeing cache space. Current size: " + this.totalDataSize);
        }
    }
    ...
    FreeSpaceAfterWriteFailure() {
        return this._FreeSpace(this.totalDataSize * freeCacheSizeRatioWriteFailure);
    };
}
