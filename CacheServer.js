...
function handleData (socket, data)
{
    ...
    {
        let buf = Buffer.allocUnsafe (data.length + socket.pendingData.length);
    ...
    while (true)
    {
        ...
        if (!socket.protocolVersion)
        {
            ...
            let buf = Buffer.allocUnsafe (UINT32_SIZE);
